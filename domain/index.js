...
},{"./account-type":36,"./account-type-chart":35,"./major-account-type":48}],35:[function(require,module,exports){
/**
...
},{"./major-account-type":48,"fs":1,"js-yaml":2}],39:[function(require,module,exports){
const { ASSET, LIABILITY, EQUITY } = require('./major-account-type')
const Money = require('./money')
...
},{"./major-account-type":48,"./money":49}],40:[function(require,module,exports){
...
},{"./account":37}],41:[function(require,module,exports){
const Account = require('./account')
...
},{"./account":37}],42:[function(require,module,exports){
...
},{"./account":37,"./account-factory":33,"./account-type":36,"./account-type-chart":35,"./account-type-chart-factory":34,"./balance-sheet":39,"./balance-sheet-repository":38,"./credit":40,"./debit":41,"./journal":44,"./journal-factory":43,"./ledger":47,"./ledger-factory":45,"./ledger-repository":46,"./major-account-type":48,"./money":49,"./subledger":50,"./trade":53,"./trade-factory":51,"./trade-side":52}],43:[function(require,module,exports){
...
},{"./journal":44,"./trade-factory":51}],44:[function(require,module,exports){
...
},{"./balance-sheet":39,"./ledger-factory":45}],45:[function(require,module,exports){
...
},{"./ledger":47,"./subledger":50}],46:[function(require,module,exports){
const fs = require('fs')
const yaml = require('js-yaml')
...
},{"./major-account-type":48,"./trade-side":52,"./util":54,"fs":1,"js-yaml":2}],47:[function(require,module,exports){
const { ASSET, LIABILITY, EQUITY, REVENUE, EXPENSE } = require('./major-account-type')
...
},{"./major-account-type":48}],48:[function(require,module,exports){
...
},{"./trade-side":52}],49:[function(require,module,exports){
const { sum } = require('./util')
...
},{"./money":49,"./trade-side":52}],51:[function(require,module,exports){
const moment = require('moment')
...
},{"./account-factory":33,"./trade":53,"./trade-side":52,"moment":32}],52:[function(require,module,exports){
/**
...
var CommaPeriodSetting = function CommaPeriodSetting(_ref) {
  var name = _ref.name;

  _classCallCheck(this, CommaPeriodSetting);
...
var CommaPeriodSetting = require('./comma-period-setting');
...
},{"./comma-period-setting":55,"./currency":56,"./document":59,"moment":32}],58:[function(require,module,exports){
'use strict';
...
var Factory = require('./document-factory');
...
var DocumentRepository = function () {
  ...
  _createClass(DocumentRepository, [{
    ...
    value: function getById(id) {
      return infrastructure.storage.get(this.createStorageKey(id), null).then(function (data) {
    ...
    value: function createStorageKey(id) {
      return 'document-' + id;
    }
  }]);
...
},{"./document-factory":57}],59:[function(require,module,exports){
'use strict';
...
var Document = function () {
  _createClass(Document, null, [{
    key: 'Factory',
    get: function get() {
      return require('./document-factory');
    }
  }, {
    key: 'Repository',
    get: function get() {
      return require('./document-repository');
    }
  ...
  function Document(_ref) {
    var id = _ref.id,
        ...
        commaPeriodSetting = _ref.commaPeriodSetting;
...
},{"./document-factory":57,"./document-repository":58}],60:[function(require,module,exports){
'use strict';
